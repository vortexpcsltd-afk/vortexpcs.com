    ...
    <>
      ...
      <group position={[0, 0, 0]}>
        ...
        {components.gpu && (
          <GPUGLTFModel
            position={[
              components.gpu.position?.[0] || 0.08,
              (components.gpu.position?.[1] || 0.08) + explosionAmount * 0.15,
              components.gpu.position?.[2] || 0.05,
            ]}
        ...
        {components.psu && (
          <PSUGLTFModel
            position={[
              components.psu.position?.[0] ?? -0.15,
              components.psu.position?.[1] ?? -0.15,
              components.psu.position?.[2] ?? -0.1,
            ]}
          ...
          <>
            ...
            <AIOPumpGLTFModel
              component={{
                ...
                name: "AIO Pump Block",
                position: components.cooler.position,
