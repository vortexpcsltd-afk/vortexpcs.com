  ...
  ({ component, isSelected, onClick, onHover }, ref) => {
    ...
    useMemo(() => {
      cloned.traverse((child: THREE.Object3D) => {
        ...
        // Hide only the left-side panels and glass panels to show interior
        if (
          child.name === "vis_TG" ||
          child.name === "chassis_vitre" ||
          child.name === "Plane001" ||
          child.name === "Plane001_1" ||
          child.name === "Plane012" ||
          child.name === "Plane012_1" ||
          child.name === "Cube001" ||
          child.name === "Cube001_1" ||
          child.name === "Cube001_2"
        ) {
          child.visible = false;
        }
