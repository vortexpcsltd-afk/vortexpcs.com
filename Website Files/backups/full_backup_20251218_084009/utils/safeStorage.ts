...
export function safeGetLocalStorage(key: string): string | null {
  try {
    ...
    console.debug(`Failed to get localStorage[${key}]:`, error);
    return null;
  }
}
...
export function safeSetLocalStorage(key: string, value: string): boolean {
  try {
    ...
    console.debug(`Failed to set localStorage[${key}]:`, error);
    return false;
  }
}
...
export function safeRemoveLocalStorage(key: string): boolean {
  try {
    ...
    console.debug(`Failed to remove localStorage[${key}]:`, error);
    return false;
  }
}
...
export function safeGetSessionStorage(key: string): string | null {
  try {
    ...
    console.debug(`Failed to get sessionStorage[${key}]:`, error);
    return null;
  }
}
...
export function safeSetSessionStorage(key: string, value: string): boolean {
  try {
    ...
    console.debug(`Failed to set sessionStorage[${key}]:`, error);
    return false;
  }
}
...
export function safeRemoveSessionStorage(key: string): boolean {
  try {
    ...
    console.debug(`Failed to remove sessionStorage[${key}]:`, error);
    return false;
  }
}
