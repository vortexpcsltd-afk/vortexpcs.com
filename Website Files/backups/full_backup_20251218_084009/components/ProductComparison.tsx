...
// Helper to render Rich Text content from Contentful
const renderRichText = (content: string | Document | undefined) => {
  ...
  // If it's a Document, render it using documentToReactComponents
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full">
                      ...
                      <tbody>
                        ...
                        {/* Description Row */}
                        {products.some(
                          (p) => p.description || p.mainProductDescription
                        ) && (
