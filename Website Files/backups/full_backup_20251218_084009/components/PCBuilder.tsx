...
const ComponentCard = ({
  ...
  const hasMultiplePrices = (() => {
    ...
    if (result && component.name) {
      console.log(
        `🏷️  Multiple prices found for ${component.name}:`,
...
export function PCBuilder({
  ...
  useEffect(() => {
    const loadCmsData = async () => {
      console.log("🔄 [PCBuilder] Starting CMS data load...");
      try {
        logger.debug(
        ...
        for (const category of categories) {
          console.log(`🔄 [PCBuilder] Fetching ${category} from CMS...`);
  ...
  useEffect(() => {
    ...
    const timeoutId = setTimeout(async () => {
      try {
        ...
        console.log("[PC Builder] Tracking category search:", {
          query,
        ...
        if (!result.success) {
          ...
          console.log("[PC Builder] Search tracked successfully");
        }
  ...
  useEffect(() => {
    ...
    const timeoutId = setTimeout(async () => {
      try {
        ...
        console.log("[PC Builder] Tracking global search:", {
          query,
          resultsCount,
        });
        ...
        if (!result.success) {
          ...
          console.log("[PC Builder] Global search tracked successfully");
        }
