...
/**
 * ComponentDetailModal - Displays detailed information about a PC component
 * Handles product images, specifications, options/configurations, and selection
 * Extracted from PCBuilder.tsx as a reusable component
 */
      ...
      >
        ...
        <div className="overflow-y-auto max-h-[90vh] p-4 sm:p-6 lg:p-8">
          ...
          <div className="space-y-6">
            ...
            {(component.mainProductDescription || component.description) && (
              <div className="bg-slate-900/60 rounded-xl p-6 border border-sky-500/20">
                ...
                {component.mainProductDescription &&
                  typeof component.mainProductDescription === "string" && (
                    <div className="text-base text-gray-300 leading-relaxed">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: component.mainProductDescription,
                        }}
                      />
                    </div>
                  )}
