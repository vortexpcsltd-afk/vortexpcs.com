...
/**
 * Image gallery component with carousel navigation, thumbnails, and fullscreen modal
 * Handles both compact and full modes, with modal variant support
 */
        ...
        {isModal ? (
          <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-slate-800 to-slate-900">
            <img
              ...
              alt={`${productName} - Image ${currentImageIndex + 1} of ${
        ...
        >
          ...
          <div className="relative">
            <AspectRatio ratio={16 / 10} className="overflow-hidden rounded-xl">
              <img
                src={productImages[currentImageIndex]}
                alt={`${productName} - High resolution image ${
                  currentImageIndex + 1
