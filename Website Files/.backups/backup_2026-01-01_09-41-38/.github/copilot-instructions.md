...
A React TypeScript e-commerce website for custom PC builds using Vite, shadcn/ui, Tailwind CSS, with optional Firebase/Stripe integrations. Features premium glassmorphism design with dark theme and cyan/blue gradients.
...
- **Config**: External service configs in `/config` (firebase, stripe)
...
- Product data via `services/cms.ts` (Contentful or fallback mock data)
