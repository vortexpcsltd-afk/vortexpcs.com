                  ...
                  ${orderData.items
                    ...
                    <div class="item">
                      <div>
                        ...
                        ${
                          item.ean
                            ? `<div style="color: #64748b; font-size: 12px; font-family: monospace;">EAN: ${item.ean}</div>`
                            : ""
                        }
                      </div>
                  ...
                  ${orderData.items
                    ...
                    <div class="item">
                      <div>
                        ...
                        ${
                          item.ean
                            ? `<div style="color: #64748b; font-size: 12px; font-family: monospace; font-weight: 600;">EAN: ${item.ean}</div>`
                            : ""
                        }
                      </div>
                      <div class="item-price">£${(
...
export { getTransporter, getBusinessInfo };
