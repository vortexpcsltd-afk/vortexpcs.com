 ...
 * Re-exports consolidated types from types/index.ts
 */

// Import and re-export consolidated types from index.ts
export type { CartItem, ShippingAddress } from "./index";

// Cart/Checkout types built on consolidated CartItem
...
// Import CartItem type for re-export above
