...
export const cooling280Variations = [
  ...
  (cpuName: string) =>
    `❄️ 280mm AIO – value intersecting performance! ${cpuName} maintains adequate cooling (70-80°C band) for sustained turbo frequencies without budgetary strain or acoustic penalty. 140mm fan efficiency delivers excellent thermal management with superior acoustics. Pragmatic optimisation!`,
];
