...
export const gradeVariations: Record<SynergyGrade, string[]> = {
  ...
  B: [
    ...
    "Impressive! You've built a very well-balanced system here. Performance will be excellent across the board. The few suggestions I have below are purely optimisation opportunities – think of them as the cherry on top of an already delicious cake. This setup will serve you extremely well!",
  ...
  C: [
    ...
    "Practical build with optimisation opportunities! This'll handle your software and games, though bottlenecks will emerge under stress. Fortunately, fixes are straightforward. Examine my suggestions – targeted changes yielding meaningful real-world gains!",
