/**
 * CTA Formatting & Budget Optimisation System
 *
 ...
 * - Grade-based budget optimisation suggestions
...
export const formatCTASection = (params: CTAFormattingParams): string[] => {
  ...
  // Budget optimisation for C-F grades (needs improvement)
  if (grade >= "C") {
    formatted.push(""); // spacing
    ...
    const intro =
      grade === "C"
        ? "Your build is acceptable but has room for optimisation."
