...
export function PCFinderSpectacular({
  ...
  return (
    <div className="min-h-screen pb-20">
      <div className="container mx-auto px-4 relative z-10">
        <PageHero
          badge="Premium PC Engineering"
          badgeIcon={<Zap className="w-4 h-4" />}
          title="Build Without Fear"
          subtitle="Power Without Limits"
          description="At Vortex PCs, we don't just assemble machines—we engineer weapons of choice for gamers, creators, and professionals who refuse to settle for anything less than the absolute best. Our PC Builder puts you in control: every component, every upgrade, every ounce of performance is yours to command."
        >
