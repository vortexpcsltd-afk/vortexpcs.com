...
export function Footer() {
  ...
  const companyLinks = [
    ...
    { label: "Vortex Vault Points", view: "vortex-vault" },
              ...
              <div className="flex justify-center mb-0.5">
                <div className="relative group">
                  ...
                  <div className="relative w-48 h-48 md:w-56 md:h-56 lg:w-60 lg:h-60 transition-transform duration-500 group-hover:scale-110">
                    <img
                      src={vortexLogo}
                      alt="Vortex PCs - Premium Custom PC Builds"
                      width="240"
                      height="240"
                      loading="lazy"
                      decoding="async"
              ...
              <div className="flex flex-wrap justify-center items-center gap-3 pt-6 pb-2">
                ...
                <div className="flex items-center gap-2 px-4 py-2 bg-white/5 backdrop-blur-xl border border-white/10 rounded-lg">
                  <img
                    ...
                    alt="Stripe Payment Gateway - Secure Payments"
                    loading="lazy"
                    decoding="async"
                ...
                <div className="flex items-center gap-2 px-4 py-2 bg-white/5 backdrop-blur-xl border border-white/10 rounded-lg">
                  <img
                    ...
                    alt="PayPal - Secure Payment Method"
                    loading="lazy"
                    decoding="async"
                    className="h-3 opacity-70"
                  />
            ...
            <div className="space-y-6">
                ...
                <li>
                  <a
                    ...
                    aria-label={`Call us at ${
                      contactInfo?.phone || "01603 975440"
                    }`}
                    className="group flex items-start gap-3 text-xs sm:text-sm text-gray-400 hover:text-sky-400 transition-colors"
                  >
              ...
              <div className="pt-2">
                <div className="flex gap-2">
                  <a
                    href="https://www.facebook.com/vortexcustompcs"
                    target="_blank"
                  ...
                  >
                    <svg
                      className="w-4 h-4 text-gray-400 group-hover:text-sky-400 transition-colors"
                      viewBox="0 0 24 24"
                      fill="currentColor"
                    >
                  ...
                  <a
                    ...
                    title="Coming Soon"
                    className="w-9 h-9 flex items-center justify-center bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg hover:bg-sky-500/10 hover:border-sky-500/30 hover:scale-110 transition-all duration-300 group opacity-50 cursor-not-allowed"
                  >
                    <svg
                      className="w-4 h-4 text-gray-400 group-hover:text-sky-400 transition-colors"
                      viewBox="0 0 24 24"
