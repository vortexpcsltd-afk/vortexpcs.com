...
const CATEGORIES = [
  ...
  { id: "motherboard", name: "Motherboard", icon: Activity },
...
export function VisualPCConfigurator() {
  ...
  const totalPrice = Object.values(buildConfig).reduce((sum, component) => {
                        ...
                        <div className="space-y-2.5">
                          ...
                          <div className="flex items-center justify-between gap-3">
                            <div className="flex flex-col">
                              ...
                              {/* Use shared PriceTag for sale display */}
                              <div className="mt-0.5">
                                <PriceTag
                                  price={comp.price}
                                  // @ts-expect-error reducedPrice is optional on Component
                                  reducedPrice={
                                    (
                                      comp as unknown as {
                                        reducedPrice?: number;
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
                  <div className="flex-1 text-center lg:text-left">
                    ...
                    <p className="text-gray-300 text-sm sm:text-base max-w-2xl">
                      ...
                      peripherals, customise further, and complete your order.
                    </p>
