...
// Removed inline Terms/Privacy modals in favour of new-tab links
      ...
      >
        {processing ? (
          ...
          <>
            ...
            Continue to PayPal - {formatCurrency(totalPrice)}
          </>
        ) : paymentMethod === "stripe" ? (
          <>
            <CreditCard className="w-5 h-5 mr-2" />
    ...
    <Card className="bg-white/5 border-white/10 backdrop-blur-xl p-6 md:p-8 hover:border-sky-500/30 transition-all duration-300">
            ...
            >
              ...
              <div className="flex items-center space-x-3 p-3 rounded-lg border border-white/10 hover:border-white/20 hover:bg-white/5 transition-all">
                ...
                >
                  ...
                  <div className="text-sm text-gray-400">
                    Book before 12pm for same day collection via DPD
                  </div>
                </Label>
              </div>
            </RadioGroup>
      ...
      {bookingStep === 2 && (
        <div className="space-y-6">
          ...
          {/* Terms/Privacy modals removed in favour of external links */}
        </div>
      )}
    ...
    <div className="min-h-screen text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        <div className="max-w-7xl mx-auto">
          <PageHero
            badge="UK-Wide PC Repair Service"
            badgeIcon={<Wrench className="w-4 h-4" />}
            title="Expert PC Repair"
            subtitle="Done Right"
            description="Professional PC repair services with UK-wide collection and return from £29.99. Expert diagnostics, genuine parts, and comprehensive warranty on all repairs."
          >
                  ...
                  <div className="relative order-2 md:order-1">
                    ...
                    <div className="relative w-40 h-52 sm:w-48 sm:h-60 md:w-64 md:h-80 flex items-center justify-center mx-auto">
                      <img
                        ...
                        alt="UK Map - Nationwide Repair Service Coverage"
                        loading="lazy"
                        decoding="async"
