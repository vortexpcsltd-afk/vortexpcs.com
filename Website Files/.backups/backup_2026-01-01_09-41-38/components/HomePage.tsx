...
export function HomePage() {
  ...
  return (
    <div className="min-h-screen text-white overflow-x-hidden">
      ...
      <div
        className="absolute inset-x-0 top-0 opacity-20 pointer-events-none bg-cover bg-center bg-no-repeat"
        style={{
          backgroundImage: `url("/gaming-keyboard.webp")`,
      ...
      {/* Dark Overlay */}
      <div
        className="absolute inset-x-0 top-0 bg-gradient-to-b from-black/60 via-black/40 to-black/80 pointer-events-none"
        style={{ maxHeight: "1350px", height: "1350px" }}
      ></div>
      ...
      <PageHero
        ...
        title={pageContent?.heroTitle || "Build Your Dream PC with Vortex"}
        subtitle={
