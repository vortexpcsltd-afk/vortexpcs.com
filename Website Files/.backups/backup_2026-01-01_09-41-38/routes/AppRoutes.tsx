...
const VortexVaultPage = lazy(() =>
  import("../components/VortexVaultPage").then((m) => ({
    default: m.VortexVaultPage,
  }))
);
  ...
  return (
    <Routes>
      ...
      <Route
        path="/vortex-vault"
        element={
          <PageErrorBoundary pageName="Vortex Vault Points">
            <Suspense fallback={<RouteLoader />}>
              <VortexVaultPage
                ...
                onNavigate={go}
                onTriggerSignup={() => setShowLoginDialog(true)}
              />
            </Suspense>
          </PageErrorBoundary>
        }
              ...
              <PCBuilder
                ...
                onAddToCart={(item) => {
                  ...
                  addToCart({
                    ...
                    originalPrice: item.originalPrice, // Preserve original price
                    reducedPrice: item.reducedPrice, // Preserve reduced price
                  });
                }}
                onOpenCart={() => setShowCartModal(true)}
              />
