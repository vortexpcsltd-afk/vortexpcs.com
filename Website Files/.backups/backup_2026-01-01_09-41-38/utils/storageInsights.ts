...
function getMessagesForTypeAndTier(type: string, tier: string): string[] {
  ...
  const typeExplanations = {
    ...
    "gen3-nvme_small": [
      ...
      "💾 Gen3 NVMe (1TB): Excellent price/performance balance! Here's why this is smart: Gen3 costs £50-60, Gen4 costs £75-90, Gen5 costs £120-150. Real-world gaming difference? Negligible (1-2 seconds). You've optimised correctly – 3,500 MB/s is plenty for gaming. If budget is tight, this is THE choice. Upgrade later if doing heavy video/3D work!",
    ...
    "gen4-nvme_adequate": [
      "⚡ 1-1.5TB Gen4 NVMe: Fantastic balance! 7,000 MB/s + ample capacity = no compromises. You'll load games in 2-4 seconds, edit 4K footage smoothly, and fit 15+ AAA games. Gen4 vs Gen5? Gen5 is 40% faster, 80% more expensive. Diminishing returns! You've optimised perfectly. This drive will serve you well for years. Add capacity later if needed, but speed is locked in!",
