...
import { Cookie, Settings, BarChart, Target, Shield, CheckCircle, X } from 'lucide-react';
...
export function CookiePolicyPage() {
  ...
  const cookieTypes = [
    ...
    },
    {
      ...
      examples: ['Advertising IDs', 'Conversion tracking', 'Retargeting', 'Social media integration'],
      required: false,
  ...
  const specificCookies = [
    { name: 'vortex_session', type: 'Essential', purpose: 'Maintains your session across pages', duration: 'Session', provider: 'Vortex PCs' },
    { name: 'vortex_cookie_consent', type: 'Essential', purpose: 'Stores your cookie preferences', duration: '1 year', provider: 'Vortex PCs' },
    { name: 'vortex_user', type: 'Essential', purpose: 'Stores authentication information', duration: '30 days', provider: 'Vortex PCs' },
    { name: 'vortex_cart', type: 'Essential', purpose: 'Remembers your shopping cart items', duration: '7 days', provider: 'Vortex PCs' },
    { name: '_ga', type: 'Analytics', purpose: 'Distinguishes unique users', duration: '2 years', provider: 'Google Analytics' },
    { name: '_gid', type: 'Analytics', purpose: 'Distinguishes unique users', duration: '24 hours', provider: 'Google Analytics' },
    { name: '_gat', type: 'Analytics', purpose: 'Throttles request rate', duration: '1 minute', provider: 'Google Analytics' },
    { name: 'fbp', type: 'Marketing', purpose: 'Facebook tracking pixel', duration: '3 months', provider: 'Facebook' },
    { name: '_gcl_au', type: 'Marketing', purpose: 'Google Ads conversion tracking', duration: '3 months', provider: 'Google Ads' }
  ];
  ...
  return (
    <div className="min-h-screen py-24">
      <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-5xl">
          ...
          <div className="flex items-start gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-300">
                Cookies are small text files that are placed on your device when you visit our website. They help us provide you with a better experience by remembering your preferences, analysing how you use our site, and enabling certain functionality. This policy explains what cookies we use and how you can control them.
              </p>
            </div>
          </div>
        </Card>
        ...
        <div className="mb-12">
          ...
          <div className="space-y-6">
            {cookieTypes.map((cookieType, index) => (
              <Card key={index} className="bg-white/5 backdrop-blur-xl border-white/10 p-6 hover:border-sky-500/30 transition-all duration-300">
                <div className="flex items-start gap-4">
                  <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${cookieType.color} opacity-20 flex items-center justify-center flex-shrink-0`}>
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        ...
                        <p className="text-sm text-gray-400">{cookieType.description}</p>
                      </div>
                      <div className="ml-4">
                        {cookieType.required ? (
                    ...
                    <tr key={index} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                      ...
                      <td className="p-4">
                        <Badge 
                          variant="outline" 
                          className={`text-xs ${
                            cookie.type === 'Essential' ? 'border-green-500/40 text-green-400' :
                            cookie.type === 'Analytics' ? 'border-blue-500/40 text-blue-400' :
                      ...
                      <td className="p-4 text-gray-400 text-sm">{cookie.purpose}</td>
                      <td className="p-4 text-gray-400 text-sm">{cookie.duration}</td>
                      <td className="p-4 text-gray-400 text-sm">{cookie.provider}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        <Card className="bg-white/5 backdrop-blur-xl border-white/10 p-8 mb-8">
          <h3 className="text-white mb-4">How to Control Cookies in Your Browser</h3>
          <p className="text-gray-300 mb-6">
            Most web browsers allow you to control cookies through their settings. However, if you disable cookies, some features of our website may not function properly.
          </p>
            ...
            {[
              ...
              <div key={index} className="flex items-center gap-3 p-4 bg-white/5 border border-white/10 rounded-lg">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-400 font-mono">{item.link}</div>
                </div>
              </div>
            ))}
          </div>
        ...
        <Card className="bg-white/5 backdrop-blur-xl border-white/10 p-8 mb-8">
          ...
          <div className="space-y-3">
            {[
              ...
              { name: 'Google Ads', purpose: 'Advertising and conversion tracking', link: 'https://policies.google.com/technologies/ads' },
              { name: 'Facebook', purpose: 'Social media integration and advertising', link: 'https://www.facebook.com/policies/cookies' }
            ].map((provider, index) => (
              <div key={index} className="flex items-start gap-3 p-4 bg-white/5 border border-white/10 rounded-lg">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-gray-400 mb-2">{provider.purpose}</div>
                  <a 
                    href={provider.link} 
                    target="_blank" 
        ...
        <Card className="bg-gradient-to-br from-sky-500/20 to-blue-500/20 border-sky-500/30 p-8">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-white mb-2">Questions About Our Cookie Policy?</h3>
              <p className="text-gray-300 mb-4">
                If you have any questions about how we use cookies, please contact us.
              </p>
              <div className="space-y-2 text-sm text-gray-300">
                <p>Email: <a href="mailto:privacy@vortexpcs.co.uk" className="text-sky-400 hover:text-sky-300 transition-colors">privacy@vortexpcs.co.uk</a></p>
                <p>Phone: <a href="tel:+442012345678" className="text-sky-400 hover:text-sky-300 transition-colors">+44 20 1234 5678</a></p>
              </div>
            </div>
          </div>
        </Card>
        ...
        <div className="mt-8 text-center text-sm text-gray-500">
          <p>Vortex PCs Ltd • Company Registration No. 12345678 • VAT No. GB123456789</p>
        </div>
      </div>
    </div>
  );
