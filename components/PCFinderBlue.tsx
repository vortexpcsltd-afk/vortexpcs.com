...
// BuildConfig interface for compatibility with PCConfigurator
                ...
                <div className="space-y-8">
                  ...
                  <div className="px-8">
                    ...
                    <div className="flex justify-between mt-2 text-sm text-gray-400">
                      <span>
                        {currentQuestion.formatValue(currentQuestion.min)}
                      </span>
                      <span>
                        {currentQuestion.formatValue(currentQuestion.max)}
                      </span>
                    </div>
                  </div>
