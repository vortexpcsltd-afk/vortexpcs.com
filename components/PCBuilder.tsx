      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-8 sm:mt-16 px-4 sm:px-6 lg:px-8">
          ...
          <Tabs defaultValue="keyboard" className="space-y-6 sm:space-y-8">
            <TabsList className="grid w-full grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 bg-white/10 backdrop-blur-xl p-1.5 sm:p-2 rounded-xl gap-1 sm:gap-1.5">
              <TabsTrigger
                value="keyboard"
                className="data-[state=active]:bg-green-500/20 data-[state=active]:text-green-300 text-xs sm:text-sm px-2 py-2.5 sm:px-4 sm:py-3 flex items-center justify-center gap-1 sm:gap-2 rounded-lg"
              >
              ...
              <TabsTrigger
                ...
                className="data-[state=active]:bg-green-500/20 data-[state=active]:text-green-300 text-xs sm:text-sm px-2 py-2.5 sm:px-4 sm:py-3 flex items-center justify-center gap-1 sm:gap-2 rounded-lg"
              >
                <Mouse className="w-3.5 h-3.5 sm:w-4 sm:h-4 flex-shrink-0" />
