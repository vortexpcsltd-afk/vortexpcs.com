...
import { Cpu, Monitor, HardDrive, Zap, Box, Fan, MemoryStick, Award, Shield, Sparkles, Info, ChevronDown, Check, AlertTriangle, X, Headphones } from 'lucide-react';
...
interface PCConfiguratorProps {
  ...
  onAddToCart?: (item: { type: 'build'; name: string; components: any; addOns: any[]; price: number }) => void;
}
...
export function PCConfigurator({ initialBuild, onNavigate, onAddToCart }: PCConfiguratorProps) {
  const [selectedComponents, setSelectedComponents] = useState<BuildComponents>({
    cpu: { name: 'AMD Ryzen 7 5700X', price: 199, specs: '8 Cores, 16 Threads, 4.6GHz Boost', badge: 'AM4', socket: 'AM4', maxTDP: 65 },
    gpu: { name: 'NVIDIA RTX 4070', price: 599, specs: '12GB GDDR6X, Ray Tracing', badge: '12GB GDDR6X', length: 304 },
    motherboard: { name: 'MSI B550 Gaming Plus', price: 139, specs: 'ATX, WiFi 6, PCIe 4.0', socket: 'AM4', ramType: 'DDR4', formFactor: 'ATX', chipset: 'B550', badge: 'AM4 • DDR4' },
    ram: { name: '32GB DDR4 3600MHz', price: 89, specs: 'Corsair Vengeance RGB', badge: 'DDR4 3600MHz', ramType: 'DDR4' },
    storage: { name: '1TB NVMe Gen4 SSD', price: 119, specs: 'Samsung 980 Pro', badge: 'PCIe 4.0' },
    psu: { name: '750W 80+ Gold', price: 99, specs: 'Corsair RM750x, Modular', badge: '80+ Gold' },
    case: { name: 'Fractal Meshify 2', price: 139, specs: 'Tempered Glass, High Airflow', badge: 'ATX', formFactor: 'ATX' },
    cooling: { name: 'Arctic Liquid Freezer II 240', price: 89, specs: 'AIO, 240mm Radiator', badge: '240mm AIO' },
  });

  const [showSchemaLogic, setShowSchemaLogic] = useState(false);
  const [activeCategory, setActiveCategory] = useState<string | null>(null);
  const [showCompatibilityWarning, setShowCompatibilityWarning] = useState(false);
  const [pendingComponent, setPendingComponent] = useState<{ component: Component; categoryId: string } | null>(null);

  const componentOptions = {
    cpu: [
      { name: 'AMD Ryzen 5 5600', price: 149, specs: '6 Cores, 12 Threads, 4.4GHz Boost', badge: 'AM4', socket: 'AM4', maxTDP: 65 },
      { name: 'AMD Ryzen 7 5700X', price: 199, specs: '8 Cores, 16 Threads, 4.6GHz Boost', badge: 'AM4', socket: 'AM4', maxTDP: 65 },
      { name: 'Intel Core i5-14600K', price: 289, specs: '14 Cores, 20 Threads, 5.3GHz Boost', badge: 'LGA1700', socket: 'LGA1700', maxTDP: 181 },
      { name: 'AMD Ryzen 7 7800X3D', price: 399, specs: '8 Cores, 16 Threads, 5.0GHz, 3D V-Cache', badge: 'AM5', socket: 'AM5', maxTDP: 120 },
      { name: 'Intel Core i7-14700K', price: 429, specs: '20 Cores, 28 Threads, 5.6GHz Boost', badge: 'LGA1700', socket: 'LGA1700', maxTDP: 253 },
      { name: 'AMD Ryzen 9 7950X', price: 599, specs: '16 Cores, 32 Threads, 5.7GHz Boost', badge: 'AM5', socket: 'AM5', maxTDP: 170 },
      { name: 'Intel Core i9-14900K', price: 589, specs: '24 Cores, 32 Threads, 6.0GHz Boost', badge: 'LGA1700', socket: 'LGA1700', maxTDP: 253 },
    ],
    gpu: [
      { name: 'NVIDIA RTX 4060', price: 299, specs: '8GB GDDR6, 1080p Gaming', badge: '8GB GDDR6', length: 244 },
      { name: 'AMD RX 7700 XT', price: 449, specs: '12GB GDDR6, 1440p Gaming', badge: '12GB RDNA 3', length: 267 },
      { name: 'NVIDIA RTX 4070', price: 599, specs: '12GB GDDR6X, Ray Tracing', badge: '12GB GDDR6X', length: 304 },
      { name: 'NVIDIA RTX 4070 Ti', price: 799, specs: '12GB GDDR6X, 4K Ready', badge: '12GB GDDR6X', length: 304 },
      { name: 'NVIDIA RTX 4080', price: 1199, specs: '16GB GDDR6X, 4K Ultra', badge: '16GB GDDR6X', length: 338 },
      { name: 'NVIDIA RTX 4090', price: 1799, specs: '24GB GDDR6X, Ultimate Performance', badge: '24GB GDDR6X', length: 336 },
    ],
    motherboard: [
      { name: 'MSI B550 Gaming Plus', price: 139, specs: 'ATX, WiFi 6, PCIe 4.0', socket: 'AM4', ramType: 'DDR4', formFactor: 'ATX', chipset: 'B550', badge: 'AM4 • DDR4' },
      { name: 'ASUS TUF B650-PLUS', price: 189, specs: 'ATX, WiFi 6E, PCIe 5.0', socket: 'AM5', ramType: 'DDR5', formFactor: 'ATX', chipset: 'B650', badge: 'AM5 • DDR5' },
      { name: 'MSI Z790 Gaming Plus WiFi', price: 229, specs: 'ATX, WiFi 6E, DDR5', socket: 'LGA1700', ramType: 'DDR5', formFactor: 'ATX', chipset: 'Z790', badge: 'LGA1700 • DDR5' },
      { name: 'ASUS ROG Strix X670E-E', price: 399, specs: 'ATX, WiFi 6E, PCIe 5.0', socket: 'AM5', ramType: 'DDR5', formFactor: 'ATX', chipset: 'X670E', badge: 'AM5 • DDR5' },
      { name: 'GIGABYTE Z790 AORUS Elite', price: 279, specs: 'ATX, WiFi 6E, PCIe 5.0', socket: 'LGA1700', ramType: 'DDR5', formFactor: 'ATX', chipset: 'Z790', badge: 'LGA1700 • DDR5' },
      { name: 'ASRock B650M-HDV', price: 119, specs: 'Micro-ATX, Basic Features', socket: 'AM5', ramType: 'DDR5', formFactor: 'Micro-ATX', chipset: 'B650', badge: 'AM5 • DDR5' },
      { name: 'ASUS ROG Strix B550-I', price: 229, specs: 'Mini-ITX, WiFi 6, Premium', socket: 'AM4', ramType: 'DDR4', formFactor: 'Mini-ITX', chipset: 'B550', badge: 'AM4 • DDR4' },
      { name: 'MSI MPG Z790I Edge WiFi', price: 299, specs: 'Mini-ITX, WiFi 6E, Premium', socket: 'LGA1700', ramType: 'DDR5', formFactor: 'Mini-ITX', chipset: 'Z790', badge: 'LGA1700 • DDR5' },
    ],
    ram: [
      { name: '16GB DDR4 3200MHz', price: 49, specs: 'Corsair Vengeance', badge: 'DDR4 3200MHz', ramType: 'DDR4' },
      { name: '32GB DDR4 3600MHz', price: 89, specs: 'Corsair Vengeance RGB', badge: 'DDR4 3600MHz', ramType: 'DDR4' },
      { name: '32GB DDR5 5600MHz', price: 139, specs: 'G.Skill Trident Z5', badge: 'DDR5 5600MHz', ramType: 'DDR5' },
      { name: '64GB DDR5 6000MHz', price: 249, specs: 'G.Skill Trident Z5 RGB', badge: 'DDR5 6000MHz', ramType: 'DDR5' },
      { name: '128GB DDR5 5600MHz', price: 449, specs: 'Corsair Dominator Platinum', badge: 'DDR5 5600MHz', ramType: 'DDR5' },
    ],
    storage: [
      { name: '500GB NVMe SSD', price: 59, specs: 'WD Blue SN570', badge: 'PCIe 3.0' },
      { name: '1TB NVMe Gen4 SSD', price: 119, specs: 'Samsung 980 Pro', badge: 'PCIe 4.0' },
      { name: '2TB NVMe Gen4 SSD', price: 219, specs: 'Samsung 990 Pro', badge: 'PCIe 4.0' },
      { name: '2TB NVMe + 2TB HDD', price: 249, specs: 'Best for creators', badge: 'PCIe 4.0 + HDD' },
      { name: '4TB NVMe Gen4 SSD', price: 429, specs: 'WD Black SN850X', badge: 'PCIe 4.0' },
    ],
    psu: [
      { name: '550W 80+ Bronze', price: 59, specs: 'EVGA BR, Non-Modular', badge: '80+ Bronze' },
      { name: '650W 80+ Gold', price: 89, specs: 'Corsair RM650x, Modular', badge: '80+ Gold' },
      { name: '750W 80+ Gold', price: 99, specs: 'Corsair RM750x, Modular', badge: '80+ Gold' },
      { name: '850W 80+ Platinum', price: 149, specs: 'Seasonic Focus PX, Modular', badge: '80+ Platinum' },
      { name: '1000W 80+ Titanium', price: 249, specs: 'Corsair HX1000, Modular', badge: '80+ Titanium' },
    ],
    case: [
      { name: 'NZXT H510 Flow', price: 89, specs: 'Mid Tower, Good Airflow', badge: 'ATX', formFactor: 'ATX' },
      { name: 'Fractal Meshify 2', price: 139, specs: 'Tempered Glass, High Airflow', badge: 'ATX', formFactor: 'ATX' },
      { name: 'Lian Li O11 Dynamic EVO', price: 179, specs: 'Premium, RGB Showcase', badge: 'ATX', formFactor: 'ATX' },
      { name: 'Fractal Define 7', price: 169, specs: 'Silent, Sound Dampened', badge: 'ATX', formFactor: 'ATX' },
      { name: 'Cooler Master NR200', price: 99, specs: 'Mini ITX, Compact', badge: 'Mini-ITX', formFactor: 'Mini-ITX' },
      { name: 'Corsair 4000D Airflow', price: 104, specs: 'Mid Tower, Excellent Airflow', badge: 'ATX', formFactor: 'ATX' },
      { name: 'Lian Li O11 Dynamic Mini', price: 129, specs: 'Compact, Premium Build', badge: 'Micro-ATX', formFactor: 'Micro-ATX' },
    ],
    cooling: [
      { name: 'Stock CPU Cooler', price: 0, specs: 'Included with CPU', badge: 'Stock' },
      { name: 'Noctua NH-D15', price: 99, specs: 'Air Cooler, Ultra Quiet', badge: 'Air Cooling' },
      { name: 'Arctic Liquid Freezer II 240', price: 89, specs: 'AIO, 240mm Radiator', badge: '240mm AIO' },
      { name: 'Arctic Liquid Freezer III 360', price: 129, specs: 'AIO, 360mm Radiator', badge: '360mm AIO' },
      { name: 'Custom Water Loop', price: 499, specs: 'Maximum Performance', badge: 'Custom Loop' },
    ],
  };

  const addOns = [
    { name: 'Silent Cooling Upgrade', price: 49, description: 'Premium quiet fans and thermal paste' },
    { name: '27" 1440p 165Hz Monitor', price: 299, description: 'Perfect match for your build' },
    { name: 'NoFearTech Lifetime Support', price: 99, description: 'Unlimited remote support for life' },
    { name: 'RGB Lighting Kit', price: 39, description: 'Addressable RGB strips and controller' },
  ];
  ...
  const getKevinInsight = () => {
    ...
    if ((gpu.includes('4090') || gpu.includes('4080')) && (cpu.includes('5600') || cpu.includes('i5-14600K'))) {
      const suggestions = [
    ...
    const totalComponentPower = gpu.includes('4090') ? 450 : gpu.includes('4080') ? 320 : gpu.includes('4070 Ti') ? 285 : gpu.includes('4070') ? 200 : 150;
    const cpuPower = cpu.includes('14900K') || cpu.includes('7950X') ? 250 : cpu.includes('14700K') || cpu.includes('7900X') ? 190 : cpu.includes('7800X3D') ? 120 : 105;
    const recommendedPSU = Math.ceil((totalComponentPower + cpuPower + 100) * 1.3 / 50) * 50;
    
    if (psuWattage < recommendedPSU - 50) {
      const warnings = [
        `Your PSU is cutting it too close for comfort. With that ${gpu} and ${cpu}, you're looking at peak draws around ${totalComponentPower + cpuPower}W. I'd strongly recommend at least ${recommendedPSU}W for stability and longevity. Don't cheap out on the PSU!`,
    ...
    if ((cpu.includes('14900K') || cpu.includes('14700K') || cpu.includes('7950X') || cpu.includes('7900X')) && cooling.includes('Stock')) {
    ...
    if ((cpu.includes('14900K') || cpu.includes('14700K')) && (cooling.includes('Stock') || cooling === 'Noctua NH-D15')) {
      const coolingAdvice = [
    ...
    if (isDDR4 && (cpu.includes('7800X3D') || cpu.includes('7950X') || cpu.includes('7900X') || cpu.includes('14700K') || cpu.includes('14900K'))) {
    ...
    if (gpu.includes('4080') && (cpu.includes('14700K') || cpu.includes('7800X3D') || cpu.includes('7900X'))) {
      const highEndPairs = [
    ...
    if (motherboard.includes('X670E') && (cpu.includes('7950X') || cpu.includes('7900X'))) {
      const premiumMobo = [
    ...
    if (motherboard.includes('B650') && (cpu.includes('7800X3D') || cpu.includes('5700X'))) {
      const valueMobo = [
    ...
    // === STORAGE INSIGHTS ===
    if (storage.includes('500GB') && (gpu.includes('4080') || gpu.includes('4090') || gpu.includes('4070 Ti'))) {
    ...
    if (storage.includes('4TB') && storage.includes('Gen4')) {
      ...
      return storageInsights[Math.floor(Math.random() * storageInsights.length)];
    }
    ...
    // === COOLING EXCELLENCE ===
    if (cooling.includes('360') && (cpu.includes('14900K') || cpu.includes('7950X'))) {
      const coolingPraise = [
    ...
    // === BALANCED BUILDS ===
    if (gpu.includes('4070 Ti') && (cpu.includes('14600K') || cpu.includes('7900X'))) {
      ...
      return balancedHighEnd[Math.floor(Math.random() * balancedHighEnd.length)];
    }

    // === PSU EFFICIENCY PRAISE ===
    if (psu.includes('Titanium') || psu.includes('Platinum')) {
      return `Appreciate seeing the quality ${psu}! High-efficiency PSUs run cooler, quieter, and will save you money on electricity over their lifetime. Plus, ${psu.includes('Titanium') ? 'Titanium' : 'Platinum'}-rated units typically have the best components and longest warranties. Worth the investment.`;
    }
    ...
    if (total > 3000) {
      const premiumInsights = [
        `You're building a premium system here - £${Math.floor(total).toLocaleString()} of enthusiast-grade hardware. With your ${gpu} and ${cpu}, this will be an absolute powerhouse that'll handle anything you throw at it for years. This is the kind of build that makes you excited to sit down at your desk!`,
        `This is a serious investment at £${Math.floor(total).toLocaleString()}, but you're getting flagship performance across the board. The ${gpu} and ${cpu} represent the best available hardware - this is how you build a no-compromises system. Proper enthusiast stuff!`
      ];
      return premiumInsights[Math.floor(Math.random() * premiumInsights.length)];
    }
  ...
  const checkCompatibility = (component: Component, categoryId: string): { compatible: boolean; warning?: string } => {
    // CPU-Motherboard socket compatibility
    if (categoryId === 'cpu') {
      if (component.socket && selectedComponents.motherboard.socket && component.socket !== selectedComponents.motherboard.socket) {
        return { 
          compatible: false, 
    ...
    if (categoryId === 'motherboard') {
      if (component.socket && selectedComponents.cpu.socket && component.socket !== selectedComponents.cpu.socket) {
        return { 
          compatible: false, 
    ...
    if (categoryId === 'ram') {
      if (component.ramType && selectedComponents.motherboard.ramType && component.ramType !== selectedComponents.motherboard.ramType) {
        return { 
          compatible: false, 
    ...
    if (categoryId === 'motherboard') {
      if (component.ramType && selectedComponents.ram.ramType && component.ramType !== selectedComponents.ram.ramType) {
        return { 
          compatible: false, 
  ...
  const getCompatibilityIssues = (): string[] => {
    ...
    if (selectedComponents.cpu.socket && selectedComponents.motherboard.socket && 
      ...
      issues.push(`⚠️ CPU socket mismatch: ${selectedComponents.cpu.name} (${selectedComponents.cpu.socket}) doesn't match motherboard (${selectedComponents.motherboard.socket})`);
    }
    
    // Check RAM-Motherboard type
    if (selectedComponents.ram.ramType && selectedComponents.motherboard.ramType && 
        selectedComponents.ram.ramType !== selectedComponents.motherboard.ramType) {
      issues.push(`⚠️ RAM incompatibility: Your motherboard requires ${selectedComponents.motherboard.ramType} but you have ${selectedComponents.ram.ramType}`);
    }
    ...
    if (moboFF === 'ATX' && caseFF && caseFF !== 'ATX') {
      issues.push(`⚠️ Form factor issue: ${moboFF} motherboard won't fit in ${caseFF} case`);
    }
    if (moboFF === 'Micro-ATX' && caseFF === 'Mini-ITX') {
      issues.push(`⚠️ Form factor issue: Micro-ATX motherboard too large for Mini-ITX case`);
    }
    if (caseFF === 'Mini-ITX' && moboFF && moboFF !== 'Mini-ITX') {
      issues.push(`⚠️ Form factor issue: Mini-ITX case requires Mini-ITX motherboard`);
    }
  ...
  return (
    <>
      ...
      <AlertDialog open={showCompatibilityWarning} onOpenChange={setShowCompatibilityWarning}>
            ...
            <AlertDialogDescription asChild>
              <div className="text-gray-300 text-base leading-relaxed mt-4">
                <div className="mb-4 p-4 rounded-lg bg-red-500/10 border border-red-500/20">
                  <div className="text-sm text-gray-400 mb-2">Message from Kevin, Founder:</div>
                ...
                <div className="mt-4 space-y-2">
                  <div className="text-sm text-gray-400 mb-2">Issues detected:</div>
                ...
                <div className="mt-6 p-3 rounded-lg bg-blue-500/10 border border-blue-500/20">
                  <div className="text-xs text-gray-400">
                    <span className="text-blue-400 font-medium">Pro Tip:</span> Use the component selection menus above to choose compatible parts. Incompatible options will be greyed out with warning icons to guide you toward working configurations.
                  </div>
                </div>
              </div>
            </AlertDialogDescription>
      ...
      <div className="min-h-screen py-12 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-400">Customise every component to match your exact needs</p>
          </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            {categories.map((category) => (
              <Card key={category.id} className="glass border-white/10 rgb-glow">
                <Collapsible
                  open={activeCategory === category.id}
                  onOpenChange={() => setActiveCategory(activeCategory === category.id ? null : category.id)}
                >
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-left">
                        <div className="flex items-center gap-2">
                          <h4>{category.name}</h4>
                          {selectedComponents[category.id as keyof BuildComponents].badge && (
                            <Badge variant="secondary" className="text-xs bg-gradient-to-r from-cyan-500/30 to-blue-500/30 text-cyan-300 border border-cyan-400/40 shadow-lg shadow-cyan-500/10">
                              {selectedComponents[category.id as keyof BuildComponents].badge}
                            </Badge>
                          )}
                        </div>
                        <div className="text-sm text-gray-400">
                          {selectedComponents[category.id as keyof BuildComponents].name}
                        </div>
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
                      <span className="text-blue-400">
                        £{selectedComponents[category.id as keyof BuildComponents].price}
                      </span>
                      <ChevronDown className={`w-5 h-5 transition-transform ${activeCategory === category.id ? 'rotate-180' : ''}`} />
                    </div>
                  </CollapsibleTrigger>
                  <CollapsibleContent>
                    <div className="px-6 pb-6 space-y-3">
                      {componentOptions[category.id as keyof typeof componentOptions].map((option, index) => {
                        const isSelected = selectedComponents[category.id as keyof BuildComponents].name === option.name;
                        return (
                          <button
                            key={index}
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex-1">
                                <div className="flex items-center gap-2 mb-1">
                                  ...
                                  {option.badge && (
                                    <Badge variant="secondary" className="text-xs bg-gradient-to-r from-cyan-500/30 to-blue-500/30 text-cyan-300 border border-cyan-400/40 shadow-lg shadow-cyan-500/10">{option.badge}</Badge>
                                  )}
                                  {isSelected && (
                                    <Check className="w-4 h-4 text-blue-400" />
                                  )}
                                </div>
                                <div className="text-sm text-gray-400">{option.specs}</div>
                              </div>
                              <div className="text-blue-400 ml-4">£{option.price}</div>
                            </div>
                          </button>
                        );
                      })}
                ...
                {addOns.map((addon, index) => (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-purple-400 ml-4">+£{addon.price}</div>
                    </div>
                  </button>
                ))}
              </div>
            ...
            <div className="sticky top-24 space-y-6">
              <Card className="glass p-6 border-white/10 rgb-glow">
                ...
                <div className="inline-flex items-center gap-2 glass px-3 py-1.5 rounded-full mb-6">
                  ...
                  <span className="text-sm text-gray-300">{getPerformanceBadge()}</span>
                </div>

                <div className="space-y-3 mb-6">
                  {categories.map((category) => (
                    <div key={category.id} className="flex justify-between text-sm">
                      <span className="text-gray-400">{selectedComponents[category.id as keyof BuildComponents].name}</span>
                      <span className="text-cyan-400">£{selectedComponents[category.id as keyof BuildComponents].price}</span>
                    </div>
                  ))}
                  {Array.from(selectedAddOns).map((index) => (
                    <div key={index} className="flex justify-between text-sm items-center gap-2">
                      <span className="text-cyan-300">{addOns[index].name}</span>
                      <span className="text-cyan-300 px-2 py-0.5 rounded bg-cyan-400/10 border border-cyan-400/20">£{addOns[index].price}</span>
                    </div>
                  ))}
                ...
                <div className="space-y-3 mb-6">
                  <Button
                    ...
                    onClick={() => alert('Adding to cart... (Mock functionality)')}
                  >
                    Add to Cart
                  </Button>
                  <Button
                  ...
                  <Button
                    ...
                    onClick={() => alert('Connecting to tech support... (Mock functionality)')}
                  >
              ...
              <Card className="glass p-6 border-white/10 rgb-glow">
                ...
                >
                  ...
                  <ChevronDown className={`w-4 h-4 transition-transform ${showSchemaLogic ? 'rotate-180' : ''}`} />
                </button>
                {showSchemaLogic && (
              ...
              <Card className="glass p-6 border-white/10 bg-gradient-to-br from-purple-600/5 to-pink-600/5 rgb-glow">
                <div className="text-xs text-gray-400 mb-2">Founder's Pick</div>
