...
export function AIAssistant({ currentPage, userContext }: AIAssistantProps) {
  ...
  const generateAIResponse = (
    ...
    // AMD vs Intel
    if (
      (lowerMessage.includes("amd") && lowerMessage.includes("intel")) ||
