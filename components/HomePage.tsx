  ...
  const features = [
    {
      ...
      description:
        "Every PC is built to order, tailored precisely to your needs and budget.",
    },
    {
      icon: Wrench,
      title: "Collect & Return Service",
      description:
        "UK-wide PC repair service. We collect, diagnose, and return your PC fully repaired.",
    },
    {
      icon: Shield,
      title: "3 Year Warranty Included",
      description:
        "Expert technical support for the lifetime of your build. We're always here to help.",
    },
    {
      icon: Zap,
      title: "5-Day Order to Delivery",
      description:
        "Quick build times and express repair options to get you up and running fast.",
    },
  ];
    ...
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="text-center space-y-8">
            <div className="inline-block">
              <div className="glass px-4 py-2 rounded-full mb-6 inline-flex items-center space-x-2">
                ...
                <span className="text-sm text-gray-300">
                  UK's Premier Custom PC Builder
                </span>
              </div>
            </div>
            ...
            <p className="max-w-2xl mx-auto text-xl text-gray-300">
              We don't do cookie‑cutter rigs. We do your rig—built fast, tested
              hard, and shipped before your next impulse buy arrives.
            </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400">
            Class-leading service, premium builds, expert support
          </p>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <Card
              key={index}
              className="glass p-6 border-white/10 hover:border-cyan-400/40 transition-all group rgb-glow"
            >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400">
            From consultation to delivery in three simple steps
          </p>
        </div>
          ...
          {[
            {
              ...
              description:
                "Answer a few questions using our PC Finder, or build from scratch with our configurator.",
            },
            {
              step: "02",
              title: "We Build It",
              description:
                "Our expert technicians hand-build your PC using premium components and rigorous testing.",
            },
            {
              step: "03",
              title: "Delivered & Supported",
              description:
                "Your PC arrives ready to go, with lifetime support and our collect & return service.",
            },
          ].map((item, index) => (
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400">
            Trusted by PC enthusiasts across the UK
          </p>
        </div>
        <div className="grid md:grid-cols-3 gap-6">
          {testimonials.map((testimonial, index) => (
            <Card
              key={index}
              className="glass p-6 border-white/10 hover:border-blue-400/30 transition-all rgb-glow"
            >
        ...
        <div className="glass rounded-3xl p-12 text-center relative overflow-hidden border border-white/10">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Start with our PC Finder to get a personalised recommendation, or
              dive straight into our configurator.
            </p>
