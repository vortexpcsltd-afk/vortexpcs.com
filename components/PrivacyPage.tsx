...
export function PrivacyPage() {
  ...
  const dataTypes = [
    { type: 'Personal Information', examples: 'Name, email, phone number, address', purpose: 'Order processing and communication' },
    { type: 'Payment Information', examples: 'Card details, billing address', purpose: 'Payment processing (not stored by us)' },
    { type: 'Technical Information', examples: 'IP address, browser type, device info', purpose: 'Website optimisation and security' },
    { type: 'Usage Information', examples: 'Pages visited, time spent, interactions', purpose: 'Service improvement and analytics' },
    { type: 'PC Build Preferences', examples: 'Component selections, specifications', purpose: 'Personalised recommendations' }
  ];
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-5xl">
          ...
          <div className="flex items-start gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-300">
                At Vortex PCs Ltd, we are committed to protecting your privacy and ensuring the security of your personal information. 
                This Privacy Policy explains how we collect, use, protect, and share your data in compliance with UK GDPR and the Data Protection Act 2018.
              </p>
            </div>
          </div>
        </Card>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-300 text-sm">
                We are fully compliant with the UK General Data Protection Regulation (UK GDPR) and the Data Protection Act 2018. 
                Your data is processed lawfully, fairly, and transparently, and you have full control over your personal information.
              </p>
            </div>
          </div>
        </Card>
                ...
                <tbody>
                  {dataTypes.map((item, index) => (
                    <tr key={index} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                      ...
                      <td className="p-4 text-gray-400 text-sm">{item.examples}</td>
                      <td className="p-4 text-gray-400 text-sm">{item.purpose}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        <div className="space-y-8">
          {sections.map((section, index) => (
            <Card key={index} className="bg-white/5 backdrop-blur-xl border-white/10 p-8 hover:border-sky-500/30 transition-all duration-300">
              <div className="flex items-start gap-4">
        ...
        <Card className="bg-white/5 backdrop-blur-xl border-white/10 p-8 mt-8">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-white mb-2">Contact Our Data Protection Officer</h3>
              ...
              <div className="space-y-2 text-sm text-gray-300">
                <p>Email: <a href="mailto:dpo@vortexpcs.co.uk" className="text-sky-400 hover:text-sky-300 transition-colors">dpo@vortexpcs.co.uk</a></p>
                <p>Phone: <a href="tel:+442012345678" className="text-sky-400 hover:text-sky-300 transition-colors">+44 20 1234 5678</a></p>
                <p>Address: Data Protection Officer, Vortex PCs Ltd, London, United Kingdom</p>
              </div>
            </div>
          </div>
        </Card>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-300 text-sm">
                ...
                Visit <a href="https://ico.org.uk" target="_blank" rel="noopener noreferrer" className="text-sky-400 hover:text-sky-300 transition-colors">ico.org.uk</a> or call 0303 123 1113.
              </p>
            </div>
          </div>
        </Card>
