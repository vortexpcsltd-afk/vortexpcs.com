  ...
  const values = [
    {
      ...
      description:
        "Every PC is a testament to my commitment to perfection and attention to detail. I don't just build computers—I craft experiences.",
    },
    {
      icon: Award,
      title: "Quality Guaranteed",
      description:
        "Only premium components make it into Vortex builds. 3-year warranties and rigorous testing ensure your investment is protected.",
    },
    {
      icon: Zap,
      title: "Lightning Fast Delivery",
      description:
        "Your custom-built PC delivered in just 5 days. Express builds without compromising on quality or attention to detail.",
    },
    {
      icon: Users,
      title: "Customer First",
      description:
        "Your satisfaction is my obsession. From consultation to delivery and beyond, expect exceptional service every step of the way.",
    },
  ];
        ...
        <div className="relative z-10 container mx-auto px-6 py-24">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="text-white">About Vortex PCs</h1>
              <div className="w-24 h-1 bg-gradient-to-r from-transparent via-sky-500 to-transparent mx-auto"></div>
            </div>

            {/* Intro text */}
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Where <span className="text-sky-400">passion</span> meets{" "}
              <span className="text-sky-400">precision</span>, and every build
              is a masterpiece engineered for peak performance.
            </p>
          </div>
        </div>
      </div>
            ...
            <Card className="bg-white/5 backdrop-blur-xl border-white/10 p-12">
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-6">
                  <div className="space-y-4">
                    <h2 className="text-white">The Man Behind the Builds</h2>
                  ...
                  <div className="space-y-4 text-gray-300">
                    <p>
                      Founded in 2025 by{" "}
                      <span className="text-white">Kevin Mackay</span>, Vortex
                      PCs Ltd was born from a lifelong passion for technology
                      and an unwavering commitment to excellence.
                    </p>
                    <p>
                      As a <span className="text-sky-400">Gen X gamer</span> and
                      entrepreneur with{" "}
                      <span className="text-sky-400">over 20 years</span> of
                      hands-on PC building experience, I've witnessed the
                      evolution of computing firsthand—from the early days of
                      enthusiast builds to today's cutting-edge systems.
                    </p>
                    <p>
                      What sets Vortex apart is my{" "}
                      <span className="text-white">
                        fanatical attention to detail
                      </span>
                      . Every cable is perfectly routed, every component
                      meticulously selected, and every system rigorously tested.
                      I don't build PCs to meet expectations—I build them to{" "}
                      <span className="text-sky-400">exceed them</span>.
                    </p>
                    <p className="text-white border-l-2 border-sky-500 pl-4 italic">
                      "Your PC isn't just a machine—it's an investment in
                      performance, reliability, and peace of mind. That's why
                      every Vortex build carries my personal guarantee of
                      excellence."
                    </p>
                  </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <p className="text-gray-400 max-w-2xl mx-auto">
                The principles that drive every decision, every build, and every
        ...
        <div className="relative z-10 container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <h2 className="text-white">Comprehensive PC Building Services</h2>
              <div className="w-24 h-1 bg-gradient-to-r from-transparent via-sky-500 to-transparent mx-auto"></div>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="bg-white/5 backdrop-blur-xl border-white/10 p-12">
              <div className="text-center space-y-8">
                <div className="space-y-4">
                  <h2 className="text-white">The Vortex Difference</h2>
                  <div className="w-24 h-1 bg-gradient-to-r from-transparent via-sky-500 to-transparent mx-auto"></div>
                </div>

                <div className="space-y-6 text-gray-300 text-left">
                  <p className="text-lg leading-relaxed">
                    When you choose Vortex PCs, you're not just getting a
                    computer—you're getting a
                    <span className="text-white"> handcrafted masterpiece</span>{" "}
                    built by someone who genuinely cares about your experience.
                  </p>

                  <p className="leading-relaxed">
                    Every system is built to order with{" "}
                    <span className="text-sky-400">premium components</span>,
                    meticulously assembled with attention to every detail, from
                    perfect cable management to optimal airflow. I personally
                    test and optimise each build before it reaches your door.
                  </p>

                  <p className="leading-relaxed">
                    With{" "}
                    <span className="text-sky-400">5-day express builds</span>{" "}
                    and an industry-leading
                    <span className="text-sky-400"> 3-year warranty</span>, you
                    get peace of mind knowing your investment is protected. And
                    with my collect & return repair service covering the whole
                    of the UK, support is never far away.
                  </p>

                  <p className="leading-relaxed">
                    But what truly sets Vortex apart is the{" "}
                    <span className="text-white">personal touch</span>. As a
                    small business, I'm not just the owner—I'm the person who
                    will consult with you, select your components, build your
                    PC, and ensure you're completely satisfied. Your success is
                    my success, and I take that responsibility seriously.
                  </p>

                  <div className="pt-6 border-t border-white/10 text-center">
                    <p className="text-xl text-sky-400">
                      Welcome to the Vortex family. Let's build something
