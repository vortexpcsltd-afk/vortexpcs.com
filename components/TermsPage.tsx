          ...
          <div className="flex items-start gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-300">
                These Terms of Service govern your use of our website and services. Please read them carefully before placing an order or using our services.
              </p>
            </div>
          </div>
        </Card>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-300 text-sm">
                ...
                If you have any questions, please contact us before proceeding with your order.
              </p>
            </div>
          </div>
        </Card>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="space-y-2 text-sm text-gray-300">
                <p>Email: <a href="mailto:legal@vortexpcs.co.uk" className="text-sky-400 hover:text-sky-300 transition-colors">legal@vortexpcs.co.uk</a></p>
