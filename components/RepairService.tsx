...
import { Wrench, Truck, Shield, Clock, MapPin, Phone, Mail, CheckCircle, AlertTriangle, Star, Calendar, Package, Key, ArrowRight } from 'lucide-react';
      ...
      <Card className="bg-white/5 border-white/10 backdrop-blur-xl p-8">
        ...
        {bookingStep === 0 && (
          <div className="space-y-6">
            ...
            <div>
              <Label className="text-white mb-3 block">Select collection & repair service</Label>
              <RadioGroup
              ...
              >
                <div className="flex items-center space-x-3 p-3 rounded-lg border border-white/10 hover:border-white/20 hover:bg-white/5 transition-all">
                  ...
                  <Label htmlFor="standard" className="text-white cursor-pointer flex-1">
                    ...
                    <div className="text-sm text-gray-400">Includes collection and return delivery</div>
                  </Label>
                </div>
                <div className="flex items-center space-x-3 p-3 rounded-lg border border-white/10 hover:border-white/20 hover:bg-white/5 transition-all">
                  ...
                  <Label htmlFor="express" className="text-white cursor-pointer flex-1">
                    ...
                    <div className="text-sm text-gray-400">Priority service with expedited collection</div>
                  </Label>
                </div>
                <div className="flex items-center space-x-3 p-3 rounded-lg border border-white/10 hover:border-white/20 hover:bg-white/5 transition-all">
                  <RadioGroupItem value="sameday" id="sameday" />
                  <Label htmlFor="sameday" className="text-white cursor-pointer flex-1">
                    <div>Same Day Service - £49.99</div>
                    <div className="text-sm text-gray-400">Book before 10am for same day collection and return</div>
                  </Label>
                </div>
              </RadioGroup>
            </div>
        ...
        {bookingStep === 1 && (
          <div className="space-y-6">
            <div>
              ...
              <div className="p-4 rounded-lg border border-blue-500/30 bg-blue-500/10">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <div className="font-medium text-white mb-1">UK-Wide Collection & Return Service</div>
                    <div className="text-sm text-gray-400">
                      We'll collect your PC from your address at a convenient time and return it when the repair is complete. Collection prices start from £29.99. Available across the entire UK.
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              <Label htmlFor="postcode" className="text-white">Enter your postcode</Label>
              ...
              <p className="text-sm text-gray-400 mt-1">We'll verify if we cover your area</p>
            </div>
        ...
        {bookingStep === 2 && (
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                <Label htmlFor="collectionPostcode" className="text-white">Collection Address</Label>
                <div className="flex gap-2 mt-2">
                  <Input
                  ...
                  <Select value={selectedAddress} onValueChange={setSelectedAddress}>
                    ...
                    <SelectContent className="bg-slate-800 border-white/10">
                      {foundAddresses.map((address, index) => (
                        <SelectItem key={index} value={address} className="text-white focus:bg-white/10">
                          {address}
                        </SelectItem>
                      ))}
                      <SelectItem value="manual" className="text-blue-400 focus:bg-white/10 font-medium">
              ...
              {(selectedAddress === 'manual' || showManualEntry) && (
                <div className="space-y-3 p-4 rounded-lg border border-white/10 bg-white/5">
                  <p className="text-sm text-gray-400 mb-2">Enter your address manually</p>
                  <div>
                    <Label htmlFor="street" className="text-white text-sm">Street Address</Label>
                    <Input
                      id="street"
                  ...
                  <div>
                    <Label htmlFor="city" className="text-white text-sm">Town/City</Label>
                    <Input
                      id="city"
                  ...
                  <div>
                    <Label htmlFor="county" className="text-white text-sm">County</Label>
                    <Input
                      id="county"
                      value={manualAddress.county}
                      onChange={(e) => setManualAddress(prev => ({ ...prev, county: e.target.value }))}
                      placeholder="County"
                      className="bg-white/5 border-white/10 text-white mt-1"
                    />
                  </div>
                  <div>
                    <Label htmlFor="manualPostcode" className="text-white text-sm">Postcode</Label>
                    <Input
                      id="manualPostcode"
              ...
              {!selectedAddress && foundAddresses.length === 0 && !showManualEntry && (
                <Button
                  type="button"
                  variant="outline"
            ...
            <Card className="bg-gradient-to-r from-blue-600/10 to-purple-600/10 border-blue-500/20 p-6">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-white capitalize">{bookingData.urgency} Collection & Return</span>
                </div>
                <div className="flex justify-between">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Professional PC repair services with UK-wide collection and return from £29.99. 
            ...
            <div className="grid md:grid-cols-4 gap-6">
              {[
                { icon: Truck, title: 'UK-Wide Collection', desc: 'From £29.99 inc. return' },
                { icon: Clock, title: 'Fast Turnaround', desc: 'Same day service available' },
          ...
          <section className="mb-20">
            <Card className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 border-blue-500/30 backdrop-blur-xl p-8 text-center">
              ...
              <p className="text-gray-300 text-lg mb-6">
                We provide collection and return services across major UK cities from £29.99
              </p>
