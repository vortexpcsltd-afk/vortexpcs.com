...
export function RepairService({
    ...
    try {
      ...
      if (data.status === 200 && data.result) {
        ...
        const addresses = [
          ...
          `Flat A, 3 ${result.parish || result.admin_ward || "Main Street"}, ${
            result.admin_district
  ...
  // Memoize BookingForm to prevent re-creation on every render
  const bookingFormContent = useMemo(() => {
    const steps = [
      "Issue Details",
      "Collection Method",
            ...
            <div className="space-y-6">
              <div>
                <Label className="text-white mb-3 block">
                  What type of issue are you experiencing? (Select all that
                  apply)
                </Label>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-400">
                        ...
                        time and return it when the repair is complete.
                        Collection prices start from £29.99. Available across
                        the entire UK.
                      </div>
                    </div>
                  </div>
              ...
              <div>
                ...
                <div className="flex gap-2 mt-2">
                  ...
                  <Button
                    ...
                    disabled={
                      isLoadingAddresses || postcode.trim().length === 0
                    }
                  >
                    {isLoadingAddresses ? (
                      <>
              ...
              <div>
                ...
                <Alert className="border-blue-500/30 bg-blue-500/10 mt-3">
                  ...
                  <AlertDescription className="text-blue-200 text-sm">
                    ...
                    to carry out diagnostics, testing, and repairs on your
                    system. Without full password access, repair work will be
                    delayed until we can contact you. Your password is kept
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-7xl mx-auto">
          ...
          <section className="mb-20" ref={bookingFormRef}>
            ...
            <div className="max-w-3xl mx-auto">{bookingFormContent}</div>
          </section>
