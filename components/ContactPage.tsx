        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="text-center space-y-6 max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-300">
              Have a question about our custom PCs or repair services? Our expert team is ready to assist you.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {contactInfo.map((item, index) => (
              <Card key={index} className="glass-strong rgb-glow p-6 hover:scale-105 transition-transform">
            ...
            <div>
              <div className="mb-8 text-center">
                ...
                <p className="text-gray-400 max-w-2xl mx-auto">
                  Fill out the form below and we'll get back to you as soon as possible. For urgent enquiries, please call us directly.
                </p>
              </div>
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <Card className="glass p-6">
                    ...
                    <p className="text-gray-400">
                      Our team of PC building experts will help you find the perfect configuration for your needs and budget.
                    </p>
                  </Card>
                  ...
                  <Card className="glass p-6">
                    ...
                    <p className="text-gray-400">
                      We only use high-quality, reliable components from trusted manufacturers to ensure peak performance.
                    </p>
                  </Card>
              ...
              <Card className="glass-strong rgb-glow p-8">
                ...
                <p className="text-gray-400 mb-6">
                  We pride ourselves on our rapid response times. Most enquiries are answered within 24 hours during business days.
                </p>
